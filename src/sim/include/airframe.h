...
public:
    ...
    {
        return MemAllocPtr(AirframeDataPool, size, 0);
    };
...
public:
    ...
    void *operator new(size_t size)
    {
        ShiAssert(size == sizeof(AirframeClass));
...
public:
    ...
    void GetGunLocation(float *x, float *y, float *z)
    {
        ...
        *z = auxaeroData->gunLocation.z;
    };
    int EngineTrail();
    float EngineSmokeFactor();
    void GetRefuelPosition(Tpoint *pos)
    {
        *pos = auxaeroData->refuelLocation;
    };
    float GetRollLimitForAiInWP()
    {
        return auxaeroData->rollLimitForAiInWP;
    }; // 2002-01-01 ADDED BY S.G.
    float GetMinTGTMAR()
    {
        return auxaeroData->minTGTMAR;
    }; // 2002-03-22 ADDED BY S.G.
    float GetMaxMARIdedStart()
    {
        return auxaeroData->maxMARIdedStart;
    }; // 2002-03-22 ADDED BY S.G.
    float GetAddMARIded5k()
    {
        return auxaeroData->addMARIded5k;
    }; // 2002-03-22 ADDED BY S.G.
    float GetAddMARIded18k()
    {
        return auxaeroData->addMARIded18k;
    }; // 2002-03-22 ADDED BY S.G.
    float GetAddMARIded28k()
    {
        return auxaeroData->addMARIded28k;
    }; // 2002-03-22 ADDED BY S.G.
    float GetAddMARIdedSpike()
    {
    ...
    int GetEngineDamageHitThreshold()
    {
        return auxaeroData->engineDamageHitThreshold;
    }; // 2002-04-11 ADDED BY S.G.

    void GetDrogueRFPos(Tpoint *pos)
    {
        *pos = auxaeroData->DrogueRFPos;
    }; // 12DEC03 - FRB
    void GetBoomRFPos(Tpoint *pos)
    {
        *pos = auxaeroData->BoomRFPos;
    }; // 12DEC03 - FRB
    float GetBoomStoredAngle()
    {
        return auxaeroData->BoomStoredAngle;
    }; // 18NOV03 - FRB
    int GetnBooms()
    {
        return auxaeroData->numBooms;
    }; // 18NOV03 - FRB
    int GetnDrogues()
    {
        return auxaeroData->numDrogues;
    }; // 18NOV03 - FRB
    int GetActiveDrogue()
    {
        return auxaeroData->activeDrogue;
    }; // 26NOV03 - FRB
    float GetDrogueExt()
    {
        return auxaeroData->DrogueExt;
    }; // 29NOV03 - FRB
    float GetRefuelAngle()
    {
        return auxaeroData->animRefuelAngle;
    }; // 01DEC03 - FRB

    // RV - Biker - Boom and drogue parents
    int GetBoomParent()
    {
        return auxaeroData->boomParent;
    };
    int GetDrogueParent()
    {
        return auxaeroData->drogueParent;
    };

    // RV - Biker - Which slot boom and drogues should be placed at
    int GetRefuelBoomSlot()
    {
        return auxaeroData->refuelBoomSlot;
    };
    int GetRefuelDrogueSlot(int slot)
    {
        return auxaeroData->refuelDrogueSlot[slot];
    };

    // RV - Biker - What tanker is it (does it have position lights)
    int GetTankerType()
    {
        return auxaeroData->tankerType;
    };

    // RV - Biker - Catapult thrust multiplier
    float GetCatapultThrustMultiplier()
    {
        return auxaeroData->catapultThrustMultiplier;
    };

    // RV - Biker - Data link capability level
    int GetDataLinkCapLevel()
    {
        return auxaeroData->dataLinkCapLevel;
    }

    // RV - Biker - Max lasing alt
    float GetMaxLasingAlt()
    {
        return auxaeroData->maxLasingAlt;
    };

    // RV - Biker - Check if AC can use programmable EWS
    int HasProgrammableEWS()
    {
        return auxaeroData->hasProgrammableEWS;
    };

    // RV - Biker - HP switch and DOF stuff
    int GetHpSwitchType(int numHP)
    {
        return int(auxaeroData->hpSwitchDofRate[numHP].x);
    };
    int GetHpDofType(int numHP)
    {
        return int(auxaeroData->hpSwitchDofRate[numHP].y);
    };
    float GetHpDofRate(int numHP)
    {
        return auxaeroData->hpSwitchDofRate[numHP].z;
    };

    // RV - Biker - Same for gun door
    int GetGunSwitchType()
    {
        return int(auxaeroData->gunSwitchDofRate.x);
    };
    int GetGunDofType()
    {
        return int(auxaeroData->gunSwitchDofRate.y);
    };
    float GetGunDofRate()
    {
        return auxaeroData->gunSwitchDofRate.z;
    };

    // RV-I-Hawk - The new HTS variable
    int GetIsHtsAble(void)
    {
        return auxaeroData->HtsAble;
    }

    //MI TFR
    bool HasTFR()
    {
        return auxaeroData->Has_TFR > 0;
    };
    float GetPID_K()
    {
        return auxaeroData->PID_K;
    };
    float GetPID_KI()
    {
        return auxaeroData->PID_KI;
    };
    float GetPID_KD()
    {
        return auxaeroData->PID_KD;
    };
    bool GetTFR_LimitMX()
    {
        return auxaeroData->TFR_LimitMX > 0;
    };
    float GetTFR_Corner()
    {
        return auxaeroData->TFR_Corner;
    };
    float GetTFR_Gain()
    {
        return auxaeroData->TFR_Gain;
    };
    float GetEVA_Gain()
    {
        return auxaeroData->EVA_Gain;
    };
    float GetTFR_MaxRoll()
    {
        return auxaeroData->TFR_MaxRoll;
    };
    float GetTFR_SoftG()
    {
        return auxaeroData->TFR_SoftG;
    };
    float GetTFR_MedG()
    {
        return auxaeroData->TFR_MedG;
    };
    float GetTFR_HardG()
    {
        return auxaeroData->TFR_HardG;
    };
    float GetTFR_Clearance()
    {
        return auxaeroData->TFR_Clearance;
    };
    float GetSlowPercent()
    {
        return auxaeroData->SlowPercent;
    };
    float GetTFR_lookAhead()
    {
        return auxaeroData->TFR_lookAhead;
    };
    float GetEVA1_SoftFactor()
    {
        return auxaeroData->EVA1_SoftFactor;
    };
    float GetEVA2_SoftFactor()
    {
        return auxaeroData->EVA2_SoftFactor;
    };
    float GetEVA1_MedFactor()
    {
        return auxaeroData->EVA1_MedFactor;
    };
    float GetEVA2_MedFactor()
    {
        return auxaeroData->EVA2_MedFactor;
    };
    float GetEVA1_HardFactor()
    {
        return auxaeroData->EVA1_HardFactor;
    };
    float GetEVA2_HardFactor()
    {
        return auxaeroData->EVA2_HardFactor;
    };
    float GetTFR_GammaCorrMult()
    {
        return auxaeroData->TFR_GammaCorrMult;
    };
    float GetLantirnCameraX()
    {
        return auxaeroData->LantirnCameraX;
    };
    float GetLantirnCameraY()
    {
        return auxaeroData->LantirnCameraY;
    };
    float GetLantirnCameraZ()
    {
    ...
    bool HasDragChute()
    {
        return auxaeroData->dragChuteCd > 0;
    };
    float DragChuteMaxSpeed()
    {
        return auxaeroData->dragChuteMaxSpeed;
    };
    bool HasManualFlaps()
    {
        return auxaeroData->hasTef == AUX_LEFTEF_MANUAL;
    };
    float TefDegrees()
    {
        return tefFactor * auxaeroData->tefMaxAngle;
    };
    float LefDegrees()
    {
        return lefFactor * auxaeroData->lefMaxAngle;
    };
    ...
    void SetEpuSwitch(EpuState mode)
    {
        epuState = mode;
    };
    void StepEpuSwitch();
    ...
    int HydraulicOK()
    {
        return hydrAB == HYDR_ALL ? 1 : 0;
    };
    void SetHydraulic(int type)
    {
        hydrAB = type;
    };
    ...
    void IncFuelSwitch();
    void DecFuelSwitch();
    void SetFuelSwitch(FuelSwitch fs)
    {
        fuelSwitch = fs;
    };
    FuelSwitch GetFuelSwitch()
    {
        return fuelSwitch;
    };
    enum FuelPump
    ...
    void IncAirSource();
    void DecAirSource();
    void SetAirSource(AirSource as)
    {
        airSource = as;
    };
    AirSource GetAirSource()
    {
        return airSource;
    };
    ...
    void SetRStick(float newStick)
    {
        rstick = newStick;
    };
    void SetYPedal(float newPedal)
    {
        ypedal = newPedal;
    };
    void SetThrotl(float newThrot)
    {
        throtl = newThrot;
    };
    float PStick(void)
    ...
    {
        return aeroDataset[vehicleIndex].inputData[which];
    }
    void DragBodypart(void);

    void SetDragIndex(float index)
    {
        dragIndex = index;
    };
    float GetDragIndex(void)
    {
        return dragIndex;
    };
    ...
    int GetRackGroup(int i)
    {
        return auxaeroData->hardpointrg[i];
    };
    int GetBingoSnd()
    {
        return auxaeroData->sndBBBingo;
    };
    int GetAltitudeSnd()
    {
...
#define SIMPLE_MODE_HF 2
    ...
    // MN
    float GetRefuelSpeed(void)
    {
        return auxaeroData->refuelSpeed;
    }
    float GetRefuelAltitude(void)
    {
        return auxaeroData->refuelAltitude;
    }
    int GetMaxRippleCount(void)
    {
        return auxaeroData->maxRippleCount;
    }
    int GetParkType();
    float GetDecelerateDistance(void)
    {
        return auxaeroData->decelDistance;
    }
    float GetRefuelFollowRate(void)
    {
        return auxaeroData->followRate;
    }
    float GetDesiredClosureFactor(void)
    {
    ...
    float GetTankerLongLeg(void)
    {
        return auxaeroData->longLeg;
    }
    float GetTankerShortLeg(void)
    {
        return auxaeroData->shortLeg;
    }
    float GetRefuelRate(void)
    {
        return auxaeroData->refuelRate;
    }
    float GetAIBoomDistance(void)
    {
        return auxaeroData->AIBoomDistance;
    }
    float GetStartGroundAvoidCheck(void)
    {
        return auxaeroData->startGroundAvoidCheck;
    }
    int LimitPstick(void)
    {
