...
public:
    ...
    {
        ShiAssert(size == sizeof(CONVERSATION));
    ...
    {
        pool = MemPoolInitFS(sizeof(CONVERSATION), 100, 0);
    };
...
public:
    ...
    void *operator new(size_t size)
    {
        ShiAssert(size == sizeof(VM_BUFFLIST));
        return MemAllocFS(pool);
    };
    void operator delete(void *mem)
    {
    ...
    static void InitializeStorage()
    {
        pool = MemPoolInitFS(sizeof(VM_BUFFLIST), 4, 0);
    };
    static void ReleaseStorage()
    {
        MemPoolFree(pool);
...
public:
    ...
    void *operator new(size_t size)
    {
        ShiAssert(size == sizeof(VM_CONVLIST));
        return MemAllocFS(pool);
    };
    void operator delete(void *mem)
    {
    ...
    static void InitializeStorage()
    {
        pool = MemPoolInitFS(sizeof(VM_CONVLIST), 100, 0);
    };
    static void ReleaseStorage()
    {
        MemPoolFree(pool);
...
public:
    ...
    int VoiceHandle(int channel)
    {
        return falconVoices[channel].FalcVoiceHandle;
    }
};
