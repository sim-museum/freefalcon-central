...
int SendEvalMessage::Encode(VU_BYTE **buf)
{
    ...
    memcpy(*buf, &dataBlock.message, sizeof(int));
    *buf += sizeof(int);
    size += sizeof(int);
...
void SendEvalData(FlightDataClass *flight_data, PilotDataClass *pilot_data)
{
    if (FalconLocalGame)
    {
        ...
        if (FalconLocalGame->GetGameType() == game_Dogfight)
        {
            ...
            memcpy(bufptr, &flight_data->camp_id, sizeof(short));
            bufptr += sizeof(short);
            size += sizeof(short);
            memcpy(bufptr, &pilot_data->pilot_slot, sizeof(uchar));
            bufptr += sizeof(uchar);
            size += sizeof(uchar);
            memcpy(bufptr, &pilot_data->aa_kills, sizeof(uchar));
            bufptr += sizeof(uchar);
            size += sizeof(uchar);
            memcpy(bufptr, &pilot_data->deaths[VS_AI], sizeof(short));
            bufptr += sizeof(short);
            size += sizeof(short);
            memcpy(bufptr, &pilot_data->deaths[VS_HUMAN], sizeof(short));
            bufptr += sizeof(short);
            size += sizeof(short);
            memcpy(bufptr, &pilot_data->score, sizeof(short));
            bufptr += sizeof(short);
            size += sizeof(short);
        ...
        else
        {
            ...
            bufptr += sizeof(uchar);
            size += sizeof(uchar);
            memcpy(bufptr, &pilot_data->ag_kills, sizeof(uchar));
            bufptr += sizeof(uchar);
            size += sizeof(uchar);
            memcpy(bufptr, &pilot_data->an_kills, sizeof(uchar));
            bufptr += sizeof(uchar);
            size += sizeof(uchar);
            memcpy(bufptr, &pilot_data->as_kills, sizeof(uchar));
            bufptr += sizeof(uchar);
            size += sizeof(uchar);
            memcpy(bufptr, &pilot_data->deaths[VS_AI], sizeof(short));
            bufptr += sizeof(short);
            ...
            bufptr += sizeof(short);
            size += sizeof(short);
            memcpy(bufptr, &pilot_data->rating, sizeof(uchar));
            bufptr += sizeof(uchar);
            size += sizeof(uchar);
        }
